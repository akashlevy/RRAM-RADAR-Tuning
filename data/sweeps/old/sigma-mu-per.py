...
pwdata = pwdata[~pwdata.groupby(['blv','wlv','addr'])['rf'].apply(is_outlier)]
grouped = pwdata.groupby(['blv','wlv','addr'])
...
pmeans.to_csv('results/pareto-mean-per.csv')
...
plt.legend()
plt.tight_layout()
plt.savefig('figs/sigma-mu-per.eps')
plt.show()
