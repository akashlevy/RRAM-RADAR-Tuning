...
# Plot
ax = means.plot(title='RESET SL Voltage Sweep', logy=False, xlim=(1.2, 1.7), ylim=(0, 15), linewidth=2, figsize=(4,3), yerr=stds/2, elinewidth=0.75, zorder=0)
...
plt.plot([2*x1-x2, 2*x2-x1], [y1-gradpw*(x2-x1), y2+gradpw*(x2-x1)], 'r:', linewidth=2, zorder=10)
plt.tight_layout()
plt.savefig('figs/fine-reset-sweep.eps')
plt.savefig('figs/fine-reset-sweep.pdf')
plt.show()
